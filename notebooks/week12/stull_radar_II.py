...
if __name__ == "__main__":
    ...
    """
    values = {"Prval": power_watts, "dBm": 10 * log10(power_watts * 1.0e3)}
    ...
    K2 = 0.93  # stull p. 245
    Pr = 10 ** (-5.8) * 1.0e-3  # dBm=-58, convert from mWatts to Watts
    La = 1
    R = 100.0  # km
